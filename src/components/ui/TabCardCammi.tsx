...
export default function SingleUnicornCardCammi() {
  const tab = {
    ...
    clientInitial: "C",
    request:
      "Create a unified platform and intelligent assistant for marketing operations.",
    result: "Personalized Marketing Document Creation ",
    // result2: "Built unified data system",
    badge1: "AI Marketing Assistant. ",
    // badge2line: "Dashboards",
    badge1Bg: "bg-pink-100 text-pink-700 border-pink-200",
    badge2: "Lead Management Intelligence",
    badge2Bg: "bg-green-100 text-green-700 border-green-200",
    icon: <Heart className="w-5 h-5 text-red-500" fill="currentColor" />,
    image: "/images/Cammi/Cammi.png",
    image2: "/images/Cammi/ScndImage.png",
  };
      ...
      <div className="flex flex-col  items-center w-[970px] h-[394px] bg-[#F3F6F8]  gap-10 lg:gap-10">
        ...
        <div className="flex gap-17 ">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative w-[210px] h-[85px] bg-white rounded-xl shadow-lg border border-gray-50">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2">
                <div className="w-[40px] h-[30px] flex-shrink-0 aspect-[4/3] bg-white border-2 border-white shadow flex items-center justify-center">
                  <img
                    src={tab.image}
            ...
            <div className="relative mt-2 mb-5  w-[250.344px] h-[42.783px] flex-shrink-0 rounded-[362.209px] bg-gradient-to-r from-[#EBEFFA] to-[#E9EDF8] flex items-center px-[5.202px] py-[2.175px] shadow-[0_0_0_0.544px_#E9EBF1,0_1.088px_2.538px_0_rgba(128,136,151,0.16),0_0.363px_0.725px_0_rgba(102,109,128,0.2)]">
              <div className="flex items-center px-[9.202px] py-[2.175px] w-[230.379px] h-[29.731px] flex-shrink-0 rounded-[362.209px] border-[0.725px] border-[#72B3FB] bg-white shadow-[0_0_0_0.544px_#E9EBF1,0_1.088px_2.538px_-0.725px_rgba(128,136,151,0.16),0_0.363px_0.725px_0_rgba(102,109,128,0.20)]">
                <p className="flex flex-col justify-center w-[201.289px] h-[9.627px] flex-shrink-0  font-[Inter] text-[10.502px] font-[500] leading-[10.502px] tracking-[-0.079px]">
                  {tab.request}
                </p>
              </div>
          ...
          <div className="flex flex-col items-center lg:items-end space-y-2 max-w-xs">
            {/* Result Box */}
            <div className="flex flex-col items-start justify-center gap-[5.507px] w-[152.28px] h-[56.199px] flex-shrink-0 px-[11.564px] pt-[11.564px] pb-[0.551px] rounded-[11.013px] border-[0.551px] border-[#0EA5E9] bg-white">
            ...
            <div className="flex flex-col items-start justify-center gap-[5.507px] w-[152.28px] h-[56.199px] flex-shrink-0 px-[5.564px] pt-[11.564px] pb-[0.551px] rounded-[11.013px] border-[0.551px] border-[#0EA5E9] bg-white">
