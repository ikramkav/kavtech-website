...
export default function SingleUnicornCardIMVI() {
  const tab = {
    ...
    clientInitial: "C",
    request: "Create a unified ",
    Scndrequest: "sports platform.",
    result: "Sports Cards",
    resultPara:
      "Interactive team and player profiles featuring live videos and updates.",

    // result2: "Built unified data system",
    badge1: " AR Integration   ",
    ResultScnd: "Sponsor Integration",
    badge2line: " Turning static images into immersive, real-world experiences",
    badge1Bg: "bg-pink-100 text-pink-700 border-pink-200",
    badge2: "Dedicated spaces for brand promotions and advertisements. ",
    badge2Bg: "bg-green-100 text-green-700 border-green-200",
    icon: <Heart className="w-5 h-5 text-red-500" fill="currentColor" />,
    image: "/images/IMVI/LogoIMVI.png",
    image2: "/images/IMVI/ScndImage.png",
  };
  ...
  "
          ...
          <div className="flex flex-col items-center lg:items-end space-y-2 max-w-xs">
            {/* Result Box */}
            <div className="flex flex-col items-start justify-center gap-[5.507px] w-[240.28px] h-[80.199px] flex-shrink-0 px-[11.564px] pt-[11.564px] pb-[0.551px] rounded-[11.013px] border-[0.551px] border-[#0EA5E9] bg-white">
              <p className=" flex-shrink-0 text-[#0A0A0A] font-[Inter] text-[9.636px] font-[700] leading-[13.766px]">
                {tab.badge1}
              </p>
              <div className="flex items-center  gap-2">
                ...
                {/* Badge Text */}
                <p className="w-[200.596px] h-[35.24px] flex-shrink-0 text-[10.152px] font-[400] leading-[11.013px]  bg-gradient-to-r from-black to-[#2EB5F2] bg-clip-text text-transparent">
                  {tab.badge2line}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center ">
              {/* Small pointer / arrow */}
              <div className="flex-shrink-0 w-[76.865px] h-[40.713px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="77"
                  height="5"
              ...
              <div className="relative mt-2 mb-2 w-[220.344px] h-[76.783px] flex-shrink-0 rounded-[4.713px] bg-gradient-to-r from-[#EBEFFA] to-[#E9EDF8] flex items-center px-[5.202px] py-[2.175px] shadow-[0_0_0_0.544px_#E9EBF1,0_1.088px_2.538px_0_rgba(128,136,151,0.16),0_0.363px_0.725px_0_rgba(102,109,128,0.2)]">
                <div className="flex flex-col justify-center flex-shrink-0  flex-shrink-0  w-[210.344px] h-[64.175px] px-[9.202px] pr-0 rounded-[4.713px] border-[0.363px] border-[#79B1E6] bg-white shadow-[0_13.053px_51.485px_0_rgba(6,11,19,0.06),0_13.053px_34.807px_0_rgba(109,80,224,0.03)]">
                  ...
                  <p className="flex flex-col justify-center flex-shrink-0  text-[11.818px] font-[400] leading-[16.882px] text-[#6A7282]">
                    {tab.resultPara}
                  </p>
                </div>
              </div>
            </div>
            <div className="flex flex-col items-start justify-center gap-[5.507px] w-[165.28px] h-[70.199px] flex-shrink-0 px-[5.564px] pt-[11.564px] pb-[0.551px] rounded-[11.013px] border-[0.551px] border-[#0EA5E9] bg-white">
              <p className="font-[Arimo] text-[16.574px] font-[400] leading-[23.677px] bg-gradient-to-r from-[#000000] via-[#000000] to-[#3099FF] bg-clip-text text-transparent">
                {tab.ResultScnd}
              </p>
              <p className="w-[165.596px] h-[40.24px] flex-shrink-0 text-[10.152px] font-[400] leading-[11.013px]  bg-gradient-to-r from-black to-[#2EB5F2] bg-clip-text text-transparent">
                {tab.badge2}
              </p>
            </div>
          </div>
